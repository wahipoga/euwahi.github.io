...
2. O uso pessoal é permitido, incluindo, mas não limitado a:  
   * Foto de perfil  
   * Papel de parede para computador ou celular  
3. Qualquer outro uso público ou comercial **precisa de autorização prévia** de Laços Profanos.  
---
## 2. Código do Site
1. O código-fonte do site é **open source**.  
2. Você pode **usar, modificar e adaptar** o código para seus próprios projetos, sem necessidade de autorização.  
---
## 3. Criações de Fãs
1. Laços Profanos **apoia a criação de fãs** e permite a monetização dessas criações, desde que sejam respeitadas algumas regras:  
   * As criações devem ter **originalidade perceptível**, seja em personagens, histórias ou cenários.  
...
1. Nenhum conteúdo criado ou compartilhado deve promover ideologias supremacistas, preconceituosas ou ilegais.  
2. Conteúdos que incluam temas sensíveis (como vilões, regimes fictícios ou comportamentos prejudiciais) **não podem romantizar ou glorificar** tais ideias.  
---
## 5. Responsabilidade
1. Laços Profanos **não se responsabiliza** por projetos criados por fãs, monetizados ou não.
2. O descumprimento destes termos pode resultar em **ações legais**.
---

## Contato
Dúvidas sobre estes termos ou sobre o uso de conteúdos da marca podem ser enviadas para: [contato@lacosprofanos.com.br](mailto:contato@lacosprofanos.com.br)
